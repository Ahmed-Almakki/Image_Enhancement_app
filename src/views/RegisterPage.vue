          ...
          <div class="content mb-3">
            ...
            <div class="log_bdy mt-5">
              ...
              <div class="d-grid col-12 mb-5">
                <button class="btn btn-outline-primary btn-lg" type="button">Sign In</button>
              </div>
              <div class="mb-5 line col-12 col-sm position-relative">
                <h4 class="d-inline">OR</h4>
              </div>
              <div class="d-grid col-12 mb-5">
                <button class="btn btn-outline-dark btn-lg d-flex align-items-center justify-content-center gap-3 border border-5" type="button">
              ...
              <div class="text-center fs-5">
                <sapn>D'not have an account? </sapn><a class="text-decoration-none">Login</a>
              </div>
            </div>
          </div>
        </div>
